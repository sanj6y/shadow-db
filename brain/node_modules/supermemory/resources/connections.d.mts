...
export declare class Connections extends APIResource {
     ...
     * ```
     */
    create(provider: 'notion' | 'google-drive' | 'onedrive' | 'gmail' | 'github' | 'web-crawler' | 's3', body?: ConnectionCreateParams | null | undefined, options?: RequestOptions): APIPromise<ConnectionCreateResponse>;
    /**
     ...
     * ```
     */
    import(provider: 'notion' | 'google-drive' | 'onedrive' | 'gmail' | 'github' | 'web-crawler' | 's3', body?: ConnectionImportParams | null | undefined, options?: RequestOptions): APIPromise<string>;
    /**
     ...
     * ```
     */
    listDocuments(provider: 'notion' | 'google-drive' | 'onedrive' | 'gmail' | 'github' | 'web-crawler' | 's3', body?: ConnectionListDocumentsParams | null | undefined, options?: RequestOptions): APIPromise<ConnectionListDocumentsResponse>;
    /**
