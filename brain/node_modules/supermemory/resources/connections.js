...
class Connections extends resource_1.APIResource {
    ...
    configure(connectionID, body, options) {
        return this._client.post((0, path_1.path) `/v3/connections/${connectionID}/configure`, { body, ...options });
    }
    /**
    ...
    deleteByID(connectionID, options) {
        return this._client.delete((0, path_1.path) `/v3/connections/${connectionID}`, options);
    }
    /**
    ...
    resources(connectionID, query = {}, options) {
        return this._client.get((0, path_1.path) `/v3/connections/${connectionID}/resources`, { query, ...options });
    }
}
