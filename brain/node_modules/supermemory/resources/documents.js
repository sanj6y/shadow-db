...
class Documents extends resource_1.APIResource {
    ...
    update(id, body = {}, options) {
        return this._client.patch((0, path_1.path) `/v3/documents/${id}`, { body, ...options });
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/v3/documents/${id}`, {
            ...options,
     ...
     */
    get(id, options) {
        return this._client.get((0, path_1.path) `/v3/documents/${id}`, options);
    }
    /**
    ...
    uploadFile(body, options) {
        return this._client.post('/v3/documents/file', (0, uploads_1.multipartFormRequestOptions)({ body, ...options }, this._client));
    }
}
